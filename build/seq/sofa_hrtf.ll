; ModuleID = 'src//sofa_hrtf.cpp'
source_filename = "src//sofa_hrtf.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_sofa_hrtf.cpp, i8* null }]
...
define internal void @_GLOBAL__sub_I_sofa_hrtf.cpp() #3 section ".text.startup" {
entry:
